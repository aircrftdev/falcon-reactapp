              ...
              <Col md={5} className="text-white text-center bg-card-gradient">
                <div className="position-relative p-4 pt-md-5 pb-md-7">
                  ...
                  <div className="z-index-1 position-relative">
                    <Link className="text-white mb-4 text-sans-serif font-weight-extra-bold fs-4 d-inline-block" to="/">
                      falcon
                    </Link>
                    <p className="text-100">
                      With the power of Falcon, you can now focus only on functionaries for your digital products, while
